<template>
  <section class="cl-empty">
    <div class="cl-empty__content">
      <div class="cl-empty__content-svg" :style="{ '--img-size': formatUnit(imageSize) }">
        <slot name="img">
      ...
      <div class="cl-empty__content-tip">
        <slot>暂无数据</slot>
      </div>
...
export default {
  ...
  props: {
    ...
    imageSize: { type: [String, Number], default: 100 },
  },
  data() {
    return {}
  },
